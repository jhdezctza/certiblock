        ...
        <Card className="shadow-xl rounded-2xl">
          ...
          <CardContent className="space-y-4">
            ...
            >
              <a
                href="/verificar"
                className="inline-block px-4 py-2 rounded-xl text-sm font-semibold bg-gradient-to-r from-green-400 to-green-600 text-white shadow-md hover:scale-105 hover:shadow-lg transition-all duration-300 ease-in-out"
              >
                ✅ Verificar Constancia de Servicio Social
              </a>
            </motion.div>
          </CardContent>
        </Card>
